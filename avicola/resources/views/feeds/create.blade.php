...
@section('content')
    <h2 style="font-size: 1.25rem; font-weight: 600; margin-bottom: 1.5rem;">Registrar Nuevo Alimento</h2>
    ...
    <div class="card">
        ...
        <form action="{{ route('feeds.store') }}" method="POST">
            ...
            <div style="display: grid; grid-template-columns: 1fr; gap: 1.5rem;">
                ...
                <div>
                    <label for="stock_kg" style="display: block; margin-bottom: 0.5rem;">Stock Inicial (kg)</label>
                    <input type="number" step="0.01" id="stock_kg" name="stock_kg" value="{{ old('stock_kg') }}" required style="width: 100%; padding: 0.5rem; border: 1px solid #e5e7eb; border-radius: 0.375rem;">
                </div>
                <div>
            ...
            <div style="margin-top: 1.5rem; text-align: right;">
                ...
                <button type="submit" style="background-color: #2563eb; color: white; padding: 0.5rem 1rem; border-radius: 0.375rem; border: none; cursor: pointer;">Guardar Alimento</button>
            </div>
        </form>
    </div>
@endsection
